...
document.getElementById('easy').addEventListener('click', function () {setGameLevel('easy');}, false);

document.getElementById('medium').addEventListener('click', function () {setGameLevel('medium');}, false);

document.getElementById('hard').addEventListener('click', function () {setGameLevel('hard');}, false);
...
document.getElementById('cardOne').addEventListener('click', function () {setPlayerCharacter('plane #1');}, false);

document.getElementById('cardTwo').addEventListener('click', function () {setPlayerCharacter('plane #2');}, false);

document.getElementById('cardThree').addEventListener('click', function () {setPlayerCharacter('plane #3');}, false);
